...
public class TC6_VerMovimientos extends Hook {

    @Test
    public void VerMovimientos() throws Exception {
        ...
        detalleHrPage.clicBotonMovimientos();
        Assert.assertTrue(detalleHrPage.seVisualizaMovimientos());
    }
}
