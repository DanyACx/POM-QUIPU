...
public class TC2_FiltrosCompletos_NhrInvalido extends Hook {



    @Test
    public void FiltrosCompletos_NhrInvalido() throws Exception {
        ...
        detalleHrPage.ingresarNHRutaInvalido();
        detalleHrPage.clicBuscar();
        Assert.assertTrue(detalleHrPage.seVisualizaResultadosInvalidosHR());
    }
